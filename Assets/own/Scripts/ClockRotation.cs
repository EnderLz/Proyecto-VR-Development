...
public class ClockRotation : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        clocSecond.transform.localRotation = Quaternion.Euler(SecondRotation, 0f, 0f);
        clockMinute.transform.localRotation = Quaternion.Euler(MinuteRotation, 0f, 0f);
        clockHour.transform.localRotation = Quaternion.Euler(HourRotation, 0f, 0f);
    }
}